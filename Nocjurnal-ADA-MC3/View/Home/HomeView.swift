    ...
    var body: some View {
        ZStack(alignment:.top) {
            ...
            HStack{
                ...
                Spacer()
                ButtonIcon("cart", state: $buttonState, type: .secondary) {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        HStack {
                            VStack(alignment: .leading, spacing: 3) {
                                Text(showtInventoryView ? "Inventory" : "Shop")
                            ...
                            Spacer()
                            ButtonRegular(showtInventoryView ? "Shop" : "Inventory", state: $buttonState, type: .secondary) {
                        ...
                        .frame(width: VPW * 2, alignment: .topLeading)
                        .offset(x: showtInventoryView ? -VPW : 0)
                    }
                    .frame(width: VPW, alignment: .topLeading)
            ...
            .padding(EdgeInsets(top: 0, leading: 24, bottom: safeAreaInsets.bottom + 90, trailing: 24))
        }
